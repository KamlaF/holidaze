...
const RegistrationForm = () => {
  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <Helmet>
        <title>Welcome to Holidaze! - register your account</title>
        <meta name="description" content="Register an account at holidaze" />
        <meta charset="utf-8" />
      ...
      >
        ...
        <div className="flex items-center justify-between">
          <button
            type="submit"
            className="bg-background hover:bg-accent-2 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
          >
            Register
          </button>
        </div>
